...
export default function ForecastingPage() {
  ...
  const handleDrillDown = (month: number) => {
    ...
    if (monthData) {
      ...
      console.log(`Income: ${incomeDetails}`);
      console.log(`Expenses: ${expenseDetails}`);
    }
  };
      ...
      <div>
        ...
        {showAddForm ? (
          <div>
            ...
            <br />
            <button onClick={() => setRecurringItems([...recurringItems, { ...newItem, id: `r${recurringItems.length + 1}` }])}>
              Add
            </button>
          </div>
        ) : (
