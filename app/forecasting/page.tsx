...
export default function ForecastingPage() {
  ...
  const handleMouseEnter = (data: any, index: number) => {
    console.log(`Mouse entered data point ${index} with value ${data.balance}`);
  };

  const handleMouseLeave = (data: any, index: number) => {
    console.log(`Mouse left data point ${index} with value ${data.balance}`);
  };

  const handleClick = (data: any, index: number) => {
    console.log(`Data point ${index} with value ${data.balance} clicked`);
  };
